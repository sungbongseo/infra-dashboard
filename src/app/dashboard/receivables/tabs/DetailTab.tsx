...
export function DetailTab({ profiles, currencyExposure, orgGap, weightedDays, isDateFiltered }: DetailTabProps) {
  // KPI 계산
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KpiCard
          ...
          reason="외화 비중을 파악하여 환율 변동에 따른 환차손 위험을 사전에 인지하고, 환 헤지 필요성을 판단합니다."
        />
        <KpiCard
          title="분석 거래처 수"
        ...
        <KpiCard
          ...
          reason="가중평균 채권연령은 전체 채권 포트폴리오의 노화 수준을 단일 지표로 요약하여 회수 전략의 시급성을 판단합니다."
        />
      </div>
      ...
      <ChartCard dataSourceType="snapshot" isDateFiltered={isDateFiltered}
        ...
        reason="주요 거래처별 채권 연령 분포를 상세 분석하여 장기 미회수 패턴을 발견하고, 거래처별 맞춤 회수 전략을 수립합니다."
      >
